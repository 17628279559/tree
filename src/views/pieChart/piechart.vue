...
onMounted(() => {
  Axios.get(getdataApi).then(response => {
    ...
    pie(3, svgRef3, get_random_data(30), pie3);
    pie(4, svgRef4, get_random_data(17), pie4);
    pie(5, svgRef5, constdata, pie5);
    pie(6, svgRef5, constdata, pie6);
    pie(7,svgRef6,co2,pie7);
  });
});
